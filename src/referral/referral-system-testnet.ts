/**
 * Referral System Examples - Testnet
 *
 * Example scripts for interacting with the referral system on testnet.
...
async function main() {
  ...
  const codeArg = process.argv[3] || "MYRefCODE123";
  ...
  try {
    switch (command) {
      case "get": {
        logger.header("🔗 Referral System: Get Referral Code (Testnet)");
      ...
      case "register": {
        if (!codeArg) {
          ...
          logger.info(
            "Usage: tsx src/referral/referral-system-testnet.ts register <CODE>"
          );
          process.exit(1);
        }

        logger.header("🔗 Referral System: Register Referral Code (Testnet)");
      ...
      case "apply": {
        if (!codeArg) {
          ...
          logger.info(
            "Usage: tsx src/referral/referral-system-testnet.ts apply <CODE>"
          );
          process.exit(1);
        }

        logger.header("🔗 Referral System: Apply Referral Code (Testnet)");
      ...
      case "check": {
        logger.header(
          "🔗 Referral System: Check Referral Code Status (Testnet)"
        );
      ...
      default:
        logger.info("Referral System CLI - Testnet");
        logger.info("");
        logger.info("Usage:");
        logger.info("  tsx src/referral/referral-system-testnet.ts get");
        logger.info(
          "  tsx src/referral/referral-system-testnet.ts register <CODE>"
        );
        logger.info(
          "  tsx src/referral/referral-system-testnet.ts apply <CODE>"
        );
        logger.info(
          "  tsx src/referral/referral-system-testnet.ts check [CODE]"
        );
        logger.info("");
        logger.info("Examples:");
        logger.info("  tsx src/referral/referral-system-testnet.ts get");
        logger.info(
          "  tsx src/referral/referral-system-testnet.ts register MYCODE123"
        );
        logger.info(
          "  tsx src/referral/referral-system-testnet.ts apply MYCODE123"
        );
        logger.info(
          "  tsx src/referral/referral-system-testnet.ts check MYCODE123"
        );
        break;
    }
  } catch (error: any) {
