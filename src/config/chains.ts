...
export const MULTICALL3_ADDRESSES: ChainMap<Address> = {
  [ChainId.BASECAMP]: basecampTestnet.contracts.multicall3.address,
...
export const BLOCK_EXPLORERS: ChainMap<{ name: string; url: string }> = {
  [ChainId.BASECAMP]: basecampTestnet.blockExplorers.default,
...
export function getContractsForChain(
  chainId: ChainId.BASECAMP | ChainId.CAMP
) {
  return {
    // Tokens
