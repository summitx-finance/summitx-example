/**
 * Launchpad Trade Example: buyExactEth
...
async function main() {
  logger.header("🚀 Launchpad Trade: buyExactEth");
  ...
  // Token to buy (example: Sticky)
  const TOKEN_TO_BUY = campMainnetLaunchpadToken.MIKO;
